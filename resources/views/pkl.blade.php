                ...
                <tbody>
                    @foreach ($pkl as $pkl)
                        <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-700">
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text text-black">{{ $pkl->siswa->nama }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $pkl->industri->nama }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $pkl->guru->nama }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $pkl->mulai }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $pkl->selesai }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
