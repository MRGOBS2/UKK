                ...
                <tbody>
                    @foreach ($siswa as $siswa)
                        <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-700">
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $siswa->nama }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $siswa->nis }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $siswa->gender }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $siswa->alamat }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $siswa->kontak }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $siswa->email }}</td>
