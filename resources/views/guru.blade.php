                ...
                <tbody>
                    @foreach ($guru as $guru)
                        <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-700">
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $guru->nama }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $guru->nip     }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $guru->gender }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $guru->alamat }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $guru->kontak }}</td>
                            <td class="border border-neutral-300 dark:border-neutral-600 px-4 py-2 text-black">{{ $guru->email }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
